...
GLuint BuildNumberZero(); // Constrói número 0 para renderização
GLuint BuildNumberOne(); // Constrói número 1 para renderização
// Pos 2
GLuint BuildNumberZeroPos2(); // Constrói número 0 para renderização
GLuint BuildNumberOnePos2(); // Constrói número 1 para renderização
// Pos 3
GLuint BuildNumberZeroPos3(); // Constrói número 0 para renderização
GLuint BuildNumberOnePos3(); // Constrói número 1 para renderização
// Pos 4
GLuint BuildNumberZeroPos4(); // Constrói número 0 para renderização
GLuint BuildNumberOnePos4(); // Constrói número 1 para renderização
...
int main() {
    ...
    GLFWwindow *window;
    window = glfwCreateWindow(1000, 500, "INF01047 - 228341 - Thiago Nitschke Simoes", NULL, NULL);
    if (!window) {
        glfwTerminate();
...
GLuint BuildNumberZeroPos2() {
    ...
    for (int i = 0; i < 64; i += 4) {
        // Vertices Externos
        NDC_coefficients[i] = 0.2f * cos(angle) - 0.25f; // X
        NDC_coefficients[i + 1] = 0.7f * sin(angle); // Y
        NDC_coefficients[i + 2] = 0.0f; // Z
        NDC_coefficients[i + 3] = 1.0f; // W
        // Vertices Internos
        NDC_coefficients[i + 64] = 0.12f * cos(angle) - 0.25f; // X
        NDC_coefficients[i + 65] = 0.6f * sin(angle); // Y
        NDC_coefficients[i + 66] = 0.0f; // Z
        NDC_coefficients[i + 67] = 1.0f; // W
    ...
    // "Ligamos" o VAO ("bind"). Informamos que iremos atualizar o VAO cujo ID
    // está contido na variável "vertex_array_object_id_1_pos_2".
    glBindVertexArray(vertex_array_object_id_1_pos_2);

    // "Ligamos" o VBO ("bind"). Informamos que o VBO cujo ID está contido na
    // variável VBO_NDC_coefficients_id_1_pos_2 será modificado a seguir. A
    // constante "GL_ARRAY_BUFFER" informa que esse buffer é de fato um VBO, e
    // irá conter atributos de vértices.
...
GLuint BuildNumberZeroPos3() {
    ...
    // "Ligamos" o VAO ("bind"). Informamos que iremos atualizar o VAO cujo ID
    // está contido na variável "vertex_array_object_id_1_pos_3".
    glBindVertexArray(vertex_array_object_id_1_pos_3);

    // "Ligamos" o VBO ("bind"). Informamos que o VBO cujo ID está contido na
    // variável VBO_NDC_coefficients_id_1_pos_3 será modificado a seguir. A
    // constante "GL_ARRAY_BUFFER" informa que esse buffer é de fato um VBO, e
    // irá conter atributos de vértices.
...
GLuint BuildNumberOnePos2() {
    ...
    // "Ligamos" o VBO ("bind"). Informamos que o VBO cujo ID está contido na
    // variável VBO_NDC_coefficients_id_2_pos_2 será modificado a seguir. A
    // constante "GL_ARRAY_BUFFER" informa que esse buffer é de fato um VBO, e
    // irá conter atributos de vértices.
...
GLuint BuildNumberOnePos3() {
    ...
    // "Ligamos" o VBO ("bind"). Informamos que o VBO cujo ID está contido na
    // variável VBO_NDC_coefficients_id_2_pos_3 será modificado a seguir. A
    // constante "GL_ARRAY_BUFFER" informa que esse buffer é de fato um VBO, e
    // irá conter atributos de vértices.
...
GLuint BuildNumberOnePos4() {
    ...
    // "Ligamos" o VBO ("bind"). Informamos que o VBO cujo ID está contido na
    // variável VBO_NDC_coefficients_id_2_pos_4 será modificado a seguir. A
    // constante "GL_ARRAY_BUFFER" informa que esse buffer é de fato um VBO, e
    // irá conter atributos de vértices.
